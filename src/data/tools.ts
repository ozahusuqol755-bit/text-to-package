...
export const mockTools: Tool[] = [
  {
    ...
    role: "Telegram-пульт / вход оператора",
    stage: ["all"],
  },
  {
    id: "t2",
    name: "Claude Code",
    role: "Оркестратор и генератор",
    stage: ["analysis", "ideas", "packs"],
  },
  ...
  { id: "t5", name: "Postgres", role: "Источник правды", stage: ["all"] },
  {
    ...
    role: "Витрина и review-таблицы",
    stage: ["review", "ideas"],
  },
  { id: "t7", name: "ScrapeCreators", role: "Сбор публичных данных", stage: ["sources"] },
  {
    id: "t8",
    name: "ViralMaxing / Virale",
    role: "Тренды, идеи, рефы конкурентов",
    stage: ["sources", "analysis"],
  },
  {
    id: "t9",
    name: "NotebookLM",
    role: "Глубокий research и summary",
    stage: ["sources", "analysis"],
  },
